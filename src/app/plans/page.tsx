					...
					<div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 mb-8 border border-gray-600/30">
						<div className="text-center">
							...
							<button
								...
								disabled={loading}
								className="bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white font-bold py-4 px-12 rounded-xl text-xl transition-all duration-200 transform hover:scale-105 shadow-lg"
							>
								{loading ? "Processing..." : selectedPlanData.price === 0 ? "Start Free Trial" : "Proceed to Payment"}
							</button>
						</div>
					</div>
				)}
